...
typedef enum {
    ...
    GFX_LOG_MODULE_DISP,
    GFX_LOG_MODULE_OBJ,
    GFX_LOG_MODULE_REFRESH,
    GFX_LOG_MODULE_RENDER,
    GFX_LOG_MODULE_TIMER,
    GFX_LOG_MODULE_TOUCH,
    GFX_LOG_MODULE_IMAGE_DECODER,
    GFX_LOG_MODULE_LABEL,
    GFX_LOG_MODULE_LABEL_OBJ,
    GFX_LOG_MODULE_LABEL_DRAW,
    GFX_LOG_MODULE_FONT_LVGL,
    GFX_LOG_MODULE_FONT_FREETYPE,
    GFX_LOG_MODULE_IMG,
