...
static const char *const s_module_names[GFX_LOG_MODULE_COUNT] = {
    ...
    [GFX_LOG_MODULE_REFRESH] = "refresh",
    [GFX_LOG_MODULE_RENDER] = "render",
    [GFX_LOG_MODULE_TIMER] = "timer",
    [GFX_LOG_MODULE_TOUCH] = "touch",
    [GFX_LOG_MODULE_IMAGE_DECODER] = "image_decoder",
    [GFX_LOG_MODULE_LABEL] = "label",
    [GFX_LOG_MODULE_LABEL_OBJ] = "label_obj",
    [GFX_LOG_MODULE_LABEL_DRAW] = "label_draw",
    [GFX_LOG_MODULE_FONT_LVGL] = "font_lvgl",
    [GFX_LOG_MODULE_FONT_FREETYPE] = "font_freetype",
    ...
    [GFX_LOG_MODULE_ANIM_DECODER] = "anim_decoder",
