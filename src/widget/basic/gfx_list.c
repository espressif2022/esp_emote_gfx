...
static esp_err_t gfx_list_draw_text(gfx_obj_t *obj, gfx_list_t *list, const gfx_draw_ctx_t *ctx,
...
static uint16_t gfx_list_visible_count(const gfx_obj_t *obj, const gfx_list_t *list)
{
    uint16_t visible;
...
static uint16_t gfx_list_max_top_index(const gfx_obj_t *obj, const gfx_list_t *list)
{
    uint16_t visible;
...
static void gfx_list_clamp_top_index(gfx_obj_t *obj, gfx_list_t *list)
{
    uint16_t max_top;
...
static void gfx_list_scroll_by_items(gfx_obj_t *obj, gfx_list_t *list, int32_t delta)
{
    int32_t next;
    uint16_t max_top;
...
#else
        free(font_handle);
        GFX_LOGW(TAG, "set list font: freetype support is not enabled");
...
static esp_err_t gfx_list_call_label_update(gfx_obj_t *obj, gfx_list_t *list,
        const char *text, const gfx_area_t *text_area)
{
    ...
    gfx_obj_t *original_align_target;
