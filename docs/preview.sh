...
echo "    - Core API:   http://localhost:$PORT/api/core/index.html"
echo "    - Widget API: http://localhost:$PORT/api/widgets/index.html"
echo "    - Doxygen:    http://localhost:$PORT/doxygen/index.html"
echo ""
echo "  按 Ctrl+C 停止服务器"
echo "=========================================="
echo ""
