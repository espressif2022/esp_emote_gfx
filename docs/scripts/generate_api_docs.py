...
HEADER_MAPPING = {
    ...
    'include/core/gfx_obj.h': ('api/core/gfx_obj.rst', 'Object System (gfx_obj)'),
    'include/core/gfx_types.h': ('api/core/gfx_types.rst', 'Type Definitions (gfx_types)'),
    'include/core/gfx_timer.h': ('api/core/gfx_timer.rst', 'Timer System (gfx_timer)'),
    'include/widget/gfx_img.h': ('api/widgets/gfx_img.rst', 'Image Widget (gfx_img)'),
    'include/widget/gfx_label.h': ('api/widgets/gfx_label.rst', 'Label Widget (gfx_label)'),
    'include/widget/gfx_anim.h': ('api/widgets/gfx_anim.rst', 'Animation Widget (gfx_anim)'),
    'include/widget/gfx_qrcode.h': ('api/widgets/gfx_qrcode.rst', 'QR Code Widget (gfx_qrcode)'),
}
