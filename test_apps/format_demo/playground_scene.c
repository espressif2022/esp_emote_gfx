...
static gfx_fs_t *s_demo_asset_store;
        ...
        const char *format_tag)
{
    ...
    s_scene.preview_title = demo_create_label(disp, s_scene.font, DEMO_PREVIEW_X, 56, preview_w, 24, "Button Preview",
    ...
    ESP_RETURN_ON_ERROR(gfx_format_demo_build_anim_demo(&s_scene), "playground", "build anim failed");
