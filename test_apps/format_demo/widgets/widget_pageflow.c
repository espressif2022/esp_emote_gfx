...
esp_err_t gfx_format_demo_build_pageflow_demo(format_playground_scene_t *scene)
{
    ...
    ESP_RETURN_ON_FALSE(obj != NULL, ESP_ERR_NO_MEM, "playground", "create pageflow failed");
    ...
    ESP_RETURN_ON_ERROR(gfx_pageflow_set_image_sources(obj, sources, DEMO_CARD_COUNT),
