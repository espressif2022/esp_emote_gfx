...
| [HW Reference](https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32s3/esp-vocat/user_guide_v1.2.html) | [HOW TO USE API](#api-reference) | [![Component Registry](https://components.espressif.com/components/espressif/esp_vocat/badge.svg)](https://components.espressif.com/components/espressif/esp_vocat) | ![maintenance-status](https://img.shields.io/badge/maintenance-actively--developed-brightgreen.svg) |
| --- | --- | --- | --- |
