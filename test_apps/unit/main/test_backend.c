...
static const gfx_backend_ops_t s_test_aligned_backend_ops = {
...
static test_aligned_backend_t *test_aligned_backend_create(gfx_render_alignment_t alignment)
{
    ...
    backend->base.ops = &s_test_aligned_backend_ops;
...
{
    static const gfx_backend_ops_t s_stride_backend_ops = {
    ...
    backend->base.ops = &s_stride_backend_ops;
...
{
    static const gfx_backend_ops_t s_capture_backend_ops = {
    ...
    backend->base.ops = &s_capture_backend_ops;
    backend->base.caps = GFX_BACKEND_CAP_FLUSH;
    backend->base.alignment = gfx_backend_get_alignment(NULL);
    return &backend->base;
}
